...
pub fn tr(lang: &str, key: &str) -> &'static str {
    match (lang, key) {
            ...
            ("en", "unreadable_label") => "unreadable",
            ("en", "times") => "readings",
            ("en", "quota_runs_out") => "runs out before it resets",
            ("en", "quota_alert_label") => "Quota pace alerts",
            ("en", "quota_alert_title") => "⚠ Quota runs out before it resets",
            ("en", "resets_in") => "resets in",
            ("en", "update_available_title") => "A newer version is available",
            ("en", "update_available_label") => "New version",
            ("en", "update_check_label") => "Check for new versions",
            ...
            (_, "unreadable_label") => "读不到",
            (_, "times") => "次",
            (_, "quota_runs_out") => "重置前会用完",
            (_, "quota_alert_label") => "额度速率提醒",
            (_, "quota_alert_title") => "⚠ 额度会在重置前用完",
            (_, "resets_in") => "重置还有",
            (_, "update_available_title") => "有新版本可用",
            (_, "update_available_label") => "新版本",
            (_, "update_check_label") => "检查新版本",
